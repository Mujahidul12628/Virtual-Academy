...
const ClassDetails = () => {
    ...
    const travelInformation = [
        ...
        { label: 'Not Included', value: ['✕ Not Included Services 1', '✕ Not Included Services 2', '✕ Not Included Services 3', '✕ Not Included Services 3'] }
    ];
    ...
    return (
        <div className='mx-auto max-w-7xl'>
            {/* <div className="h-[150px] sm:h-[170px] lg:h-[200px] xl:h-[250px] bg-cyan-50 flex flex-col items-center justify-center "> */}
            <div className="h-[150px] sm:h-[170px] lg:h-[200px] xl:h-[250px] relative flex flex-col items-center justify-center bg-cover bg-center mb-5 bg-blend-darken bg-[url('https://i.ibb.co/hMFqR2m/Data.jpg')]">
                <div className="absolute w-full bg-black opacity-90"></div>
                <div className="z-10 p-5 mx-auto text-center sm:w-2/3 sm:pl-10">
                    <h2 className="text-5xl font-bold text-black sm:text-3xl ">
                        Class Pages
                    </h2>
                </div>
            </div>
            <div className='grid grid-cols-12 gap-4 mx-auto max-w-7xl md:grid-cols-12'>
                {classData ? (
                    <>
                        ...
                        <div className="col-span-12 border-2 md:col-span-8 class-image">
                            ...
                            <div>
                                <div className="flex my-5 space-x-2">
                                    <button
                                        ...
                                        className={`py-2 px-4 rounded ${activeTab === 1 ? 'bg-cyan-500 text-white' : 'bg-gray-300 text-gray-700'
                                            }`}
                                    >
                                        Overview
                                    </button>
                                    <button
                                        ...
                                        className={`py-2 px-4 rounded ${activeTab === 2 ? 'bg-cyan-500 text-white' : 'bg-gray-300 text-gray-700'
                                            }`}
                                    >
                                        Curriculum
                                    </button>
                                        ...
                                        <>
                                            {classData.course_content && classData.course_content.length > 0 ? (
                                                <table className="min-w-full p-1 border bg-slate-300 border-slate-400">
                                                    <thead>
                                                        <tr>
                                                            <th className="py-2 font-medium tracking-wider text-center text-gray-900 uppercase border sm:px-6 sm:py-3 text-md border-slate-400">Syllabus</th>
                        ...
                        <div className="w-full col-span-12 mx-auto border-2 shadow-xl md:col-span-4 teacher-info">
